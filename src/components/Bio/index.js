...
function Bio() {
  return (
    <section className="flex flex-col justify-between min-h-bio-mobile sm:h-bio">
      {/* Terrible practice to add extra item so my content is centered with space-between :clown: */}
      <div />
      <div className="flex flex-col justify-center items-center gap-6 sm:gap-24 sm:flex-row">
        <Avatar />
        <div className="flex flex-col items-center gap-6">
          <div>
            <h1 className="text-5xl sm:text-8xl">Faïssal Hattou</h1>
